...
import { createInvoice, State } from '@/app/lib/actions'; // Import State type
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <div className="flex gap-4">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="pending"
                  className="ml-2 flex cursor-pointer items-center rounded-full bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-600"
                >
              ...
              <div className="flex items-center">
                ...
                <label
                  htmlFor="paid"
                  className="ml-2 flex cursor-pointer items-center rounded-full bg-green-500 px-3 py-1.5 text-xs font-medium text-white"
                >
